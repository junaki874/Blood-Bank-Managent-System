...
if(!empty($_POST["username"])) {
  ...
  $sql = "INSERT INTO collection(username,name,bld_grp,quantity,adr,date, day ,time ) VALUES ('" . $username . "','" . $name . "','" .$bld_grp . "','" .$quantity. "','" .$adr  . "','" .$date  . "','" .$day  . "','" .$time  . "')";
  $faq_id = $db_handle->executeInsert($sql);
	if(!empty($faq_id)) {
		$sql = "SELECT * from collection WHERE ID = '$faq_id' ";
