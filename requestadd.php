...
if(!empty($_POST["reason"])) {
  ...
  $sql = "INSERT INTO request(reason,hospital_name,hospital_adress,contact_num,blod_grp ,time ) VALUES ('" . $reason . "','" . $hospital_name . "','" .$hospital_adress . "','" .$contact_num . "','" .$blod_grp  . "','" .$time  . "')";
  $faq_id = $db_handle->executeInsert($sql);
	if(!empty($faq_id)) {
		$sql = "SELECT * from request WHERE ID = '$faq_id' ";
